const questionBank = [
 ...
 function RandomQuestion(){
    ...
    while(i<5)
    {
        ...
        arr.push[questionBank[index],questionBank[length-1]] = [questionBank[length-1],questionBank[index]];
        length--,i++;
 ...
 selected_question.forEach((problem,index)=>{
    ...
    problem['option'].forEach((data) =>{
        ...
        div_element.appendChild(createElement('br'))
    })
